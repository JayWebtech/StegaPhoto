...
const Flow = () => {
    ...
    return (
        <main className="relative">
            <div className="absolute top-0 w-full bg-gradient-to-b from-blue-900 to-gray-800 opacity-50"></div>
            <div className="py-10 container xl:max-w-screen-xl mx-auto px-8">
                <noscript>
            ...
            <div className="absolute pt-32 w-full bg-gradient-to-t from-blue-900 to-gray-800 opacity-10"></div>
        </main>
    );
};
